...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-black p-4">
      ...
      {/* Sign-in card */}
      <Card className="w-full max-w-md bg-[#111]/80 backdrop-blur-md border-[#333]/50 shadow-xl text-white relative z-10">
        <CardContent className="p-6">
          <div className="text-center">
            <h1 className="text-2xl font-semibold tracking-tight mb-1 font-[Inter]">Welcome Back</h1>
            <p className="text-sm text-gray-400 mb-6">Sign in to your Visiona account</p>
          </div>

          {/* Social auth buttons */}
          <div className="flex justify-center gap-4 mb-6">
            <Button variant="outline" size="icon" className="bg-[#222] hover:bg-[#333] border-[#444] p-2">
          ...
          <div className="relative mb-6">
            <div className="absolute inset-0 flex items-center">
              <Separator className="w-full border-[#333]" />
            </div>
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#111] px-2 text-gray-400 uppercase">OR</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 text-left">
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                required
                className="w-full px-3 py-2 rounded bg-[#1a1a1a] border border-[#333] text-white"
              />
            </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link href="/auth/forgot-password" className="text-xs text-[#1eb8cd] hover:text-[#1eb8cd]/80">
                  Forgot password?
                </Link>
              </div>
              <Input
            ...
            <Button
              type="submit"
              className="w-full bg-[#1eb8cd] hover:bg-[#1eb8cd]/80 text-white mt-4"
              disabled={isLoading}
            >
          ...
          <div className="text-center text-sm mt-6">
            <p className="text-gray-400">
              ...
              <Link href="/auth/signup" className="text-[#1eb8cd] hover:text-[#1eb8cd]/80">
                Sign up
              </Link>
            </p>
          </div>
          ...
          <div className="text-center text-xs text-gray-500 mt-4">
            <p>
              ...
              <Link href="/terms" className="text-[#1eb8cd] hover:text-[#1eb8cd]/80">
                Terms
              </Link>{" "}
              &{" "}
              <Link href="/privacy" className="text-[#1eb8cd] hover:text-[#1eb8cd]/80">
                Privacy
              </Link>
            </p>
          </div>
